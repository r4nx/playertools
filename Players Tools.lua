...
function cmdPTHelp()
    local helpText =
    [[
{4DA6FF}/pthelp{66FF66} - ������ �� �������
{4DA6FF}/ptreload{66FF66} - ������������� ���������
{4DA6FF}/det <id/nickname>{66FF66} - ������������� ������
{4DA6FF}/undet <id/nickname>{66FF66} - ��������� ������������� ������
{4DA6FF}/detectlist{66FF66} - ������ ������������� �������
{4DA6FF}/dod{66FF66} - ����������� ��� ���������� ������
{4DA6FF}/tod{66FF66} - ����������� ������ ��� ����������
{4DA6FF}/track <id>{66FF66} - ��������� ������ (��������� �� ���� �����)
    {FFCC66}��� �������� ���� ����� ����������� /track ��� ����������
{4DA6FF}/si{66FF66} - ������ ������� � ���� ����������]]
    sampShowDialog(1337761, '{FFCC00}Player Tools', helpText, '�������', '', DIALOG_STYLE_MSGBOX)
end
